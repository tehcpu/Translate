 ...
 * {@link HistoryMain.OnFragmentInteractionListener} interface
...
public class HistoryMain extends Fragment {
    ...
    private static HistoryMain Instance;
     ...
     * @return A new instance of fragment HistoryMain.
     */
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.historyMainList);
...
//        }
    ...
    public static HistoryMain getInstance() {
        HistoryMain localInstance = Instance;
        if (localInstance == null) {
            synchronized (HistoryMain.class) {
                localInstance = Instance;
                if (localInstance == null) {
                    Instance = localInstance = new HistoryMain();
                }
            }
        }
